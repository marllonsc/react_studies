...
export const LeaveAReview: React.FC<{ submitReview: any}> = (props) => {
    ...
    return(
        <div className="dropdown" style={{cursor: 'pointer'}}>
            ...
            <StarReview rating={starInput} size={32}></StarReview>
            {displayInput &&
            <form method="POST" action="#">
                ...
                <div><button type="button" onClick={() => props.submitReview(starInput, reviewDescription)} className="btn btn-primary mt-3">Submit Review</button></div>
            </form>
            }
        </div>
    );
