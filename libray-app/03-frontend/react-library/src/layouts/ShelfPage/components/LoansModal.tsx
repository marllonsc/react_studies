                                ...
                                <div className="row">
                                    <div className="col-2">
                                        {props.shelfCurrentLoan.book?.img ?
                                            ...
                                            <img src={require('./../../../Images/BooksImages/book-luv2code-1000.png')} width={56} height={87} alt="Book"></img>}
                                    </div>
                                ...
                                <div className="list-group mt-3">
                                    ...
                                    <button onClick={props.shelfCurrentLoan.daysLeft < 0 ? (event) => event.preventDefault() : () => props.renewLoan(props.shelfCurrentLoan.book.id)} data-bs-dismiss="modal"
                                        className={props.shelfCurrentLoan.daysLeft < 0 ?
                                            'list-group-item list-group-item-action inactiveLink' : 'list-group-item list-group-item-action'}>
